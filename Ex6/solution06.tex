...
56,67,78,69,93,83,3 10,10 11 & $([-\infty,+\infty],[-\infty,+\infty])$ & $([-1,-1],[-\infty,+\infty])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$\\

67,78,69,93,83,3 10,10 11 & $([-\infty,+\infty],[-\infty,+\infty])$ & $([-1,-1],[-\infty,+\infty])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $([-1,-1],[1,1])$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$\\

78,69,93,83,3 10,10 11 & $([-\infty,+\infty],[-\infty,+\infty])$ & $([-1,-1],[-\infty,+\infty])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $([-1,-1],[2,2])$ & $([-1,-1],[1,1])$ & $([-1,-1],[1,1])$ & $\emptyset$ & $\emptyset$ & $\emptyset$ & $\emptyset$\\
